 ...
 * @version  V5.00
 * @date     02. March 2016
 * $Id: system_SY7T_M11.h 24690 2020-04-28 22:52:21Z rvandewa $
 ******************************************************************************/
/*
...
// Location of the bandgap trim value and associated constants; 
// It is inverted, a signed 2s complement 8 bit number.
#define TRIMT_INDEX 0x0B // Flash information block number
#define TRIMT_LEFT_SHIFT 8 // Left to get sign bit in MSB
#define TRIMT_RIGHT_SHIFT 24 // Right to make signed 32-bit number
/* These convert from device-portable floating-point temperataure-coefficients
 * in units of stemp and stemp^2, to integer polynomial coefficients. */
#define TC1_TO_PPMC  2.684354560e8  // 2^28
#define TC2_TO_PPMC2 1.717986918e10 // 2^34
#define VREFNOM 1.213               // SoC's voltage reference at 22C
